    ...
    <div
      ...
      <div className='flex h-screen md:h-auto flex-col flex-col bg-color-1 text-color-1 max-w-full w-full md:w-130 md:rounded shadow'>
        ...
        >
          ...
          <div className='text-center text-lg mt-2  text-white'>账号登录</div>
          <div className='text-center text-secondary mt-2 text-sm   text-white text-opacity-20'>欢迎使用 DUX 管理系统</div>
        </div>
        <div className='p-6'>
