...
export function createRequest(config: {
  ...
  middle: {
     ...
     * @param callback 回调
     * @param common 是否用在全局
     * @param before 是否将中间件前置
     * @returns 
     */
    before: (callback: Request.middle["before"], common: boolean, before: boolean) => {
      remove: () => void
    }
    /**
     * 请求结果中间件
     ...
     * @returns 
     */
    result: (callback: Request.middle["result"], common: boolean, before: boolean) => {
      remove: () => void
    }
    /**
     * 请求错误中间件
     ...
     * @returns 
     */
    error: (callback: Request.middle["error"], common: boolean, before: boolean) => {
      remove: () => void
    }
  },
